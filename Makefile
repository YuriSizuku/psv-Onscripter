...
INSTALL_OBJS = \
	vpkinstall/filesystem.o \
	vpkinstall/sha1.o \
	vpkinstall/vitaPackage.o \
	$(HEAD_BIN:%.bin=%.o)	
...
%.o : %.c
	@echo [CC] $<
	@$(PREFIX)-g++ $(CCFLAGS) -c $(OBJDIR)/$< -o $(OBJDIR)/$@
